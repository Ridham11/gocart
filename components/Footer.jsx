...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "6005502979", path: '/', icon: MailIcon },
                { text: "ridham123.mishra@gmail.com", path: '/', icon: PhoneIcon },
                { text: "Bengaluru,India", path: '/', icon: MapPinIcon }
            ]
        }
    ];
    ...
    const socialIcons = [
        ...
        { icon: InstagramIcon, link: "https://www.instagram.com/ridham__mishra__?igsh=ZHp5OHM2cDk2c2N3" },
        { icon: TwitterIcon, link: "https://x.com/RidhamMishra?t=YmkB8fptWc5plhboiI0efQ&s=09" },
        { icon: LinkedinIcon, link: "https://www.linkedin.com/in/ridham-mishra-35319a253?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
    ]
